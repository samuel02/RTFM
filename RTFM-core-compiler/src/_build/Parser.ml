  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState22 ->
        ...
        | RCP ->
            ...
            let _v : (AST.stmt) =                              ( Claim (_2, _4) ) in
    ...
    | MenhirState4 ->
        ...
        | RCP ->
            ...
            let _ = _menhir_discard _menhir_env in
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((((_menhir_stack, _menhir_s), _2), _3), _, _5) = _menhir_stack in
            let _v : (AST.top) =                                   ( Isr (SOFT, _2, _3, _5) ) in
    ...
    | MenhirState36 ->
        ...
        | RCP ->
            ...
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((((_menhir_stack, _menhir_s), _2), _3), _, _5) = _menhir_stack in
            let _v : (AST.top) =                                  ( Isr (HARD, _2, _3, _5) ) in
            _menhir_goto_top _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
            _menhir_env._menhir_shifted <- (-1);
    ...
    | MenhirState43 ->
        ...
        | RCP ->
            ...
            let _ = _menhir_discard _menhir_env in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (((((_menhir_stack, _menhir_s), _2), _3), _4), _, _6) = _menhir_stack in
            let _v : (AST.top) =                                     ( Func (_2, _3, _4, _6) ) in
            _menhir_goto_top _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
            _menhir_env._menhir_shifted <- (-1);
...
and _menhir_goto_list_top_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (AST.top list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState47 ->
        ...
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, x), _, xs) = _menhir_stack in
        let _v : (AST.top list) =     ( x :: xs ) in
        _menhir_goto_list_top_ _menhir_env _menhir_stack _menhir_s _v
    | MenhirState0 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        let _tok = _menhir_env._menhir_token in
        ...
        | EOF ->
            ...
            let _v : (AST.prog option) =                                     ( Some (Prog (_1)) ) in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _1 = _v in
            Obj.magic _1
        ...
        | AFTER ->
            ...
            | INTVAL _v ->
                ...
                | SC ->
                    ...
                    let _v : (AST.stmt) =                                     ( PendAfter (_2, _4) ) in
                    _menhir_goto_stmt _menhir_env _menhir_stack _menhir_s _v
                | _ ->
                    assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
                    _menhir_env._menhir_shifted <- (-1);
...
and _menhir_run23 : _menhir_env -> 'ttv_tail -> _menhir_state -> (string) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    let _menhir_stack = Obj.magic _menhir_stack in
    let _1 = _v in
    let _v : (AST.stmt) =                  ( ClaimC (_1) ) in
    _menhir_goto_stmt _menhir_env _menhir_stack _menhir_s _v

and _menhir_goto_top : _menhir_env -> 'ttv_tail -> _menhir_state -> (AST.top) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
    ...
    | EOF ->
        _menhir_reduce3 _menhir_env (Obj.magic _menhir_stack) MenhirState47
    | _ ->
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        _menhir_env._menhir_shifted <- (-1);
    ...
    | ID _v ->
        ...
        | INTVAL _v ->
            ...
            | LCP ->
                ...
                | RCP ->
                    _menhir_reduce1 _menhir_env (Obj.magic _menhir_stack) MenhirState36
                | _ ->
                    assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
                    _menhir_env._menhir_shifted <- (-1);
        ...
        | ID _v ->
            ...
            | PARAMS _v ->
                ...
                | LCP ->
                    ...
                    | RCP ->
                        _menhir_reduce1 _menhir_env (Obj.magic _menhir_stack) MenhirState43
                    | _ ->
                        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
                        _menhir_env._menhir_shifted <- (-1);
...
and _menhir_run46 : _menhir_env -> 'ttv_tail -> _menhir_state -> (string) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    let _menhir_stack = Obj.magic _menhir_stack in
    let _1 = _v in
    let _v : (AST.top) =                                     ( TopC (_1) ) in
    _menhir_goto_top _menhir_env _menhir_stack _menhir_s _v

and prog : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (AST.prog option) =
  fun lexer lexbuf ->
    ...
    match _tok with
    | CCODE _v ->
        _menhir_run46 _menhir_env (Obj.magic _menhir_stack) MenhirState0 _v
    | FUNC ->
